...
const PATHS: Record<string, string> = {
  ...
  play: '<path d="m9 18 8-6-8-6z"/><rect x="3" y="3" width="18" height="18" rx="2"/>',
...
export const Icon: React.FC<{ name: string; className?: string }> = ({ name, className }) => (
  <span className={`icon ${className || ''}`} aria-hidden="true">
    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" dangerouslySetInnerHTML={{ __html: PATHS[name] || PATHS.help }} />
  </span>
);
