...
export const ProjectList: React.FC<ProjectListProps> = ({ onOpenProject }) => {
    ...
    return (
        <Card data-edit="projects" data-edit-label="项目作品" variant="liquid" className="dashboard-surface-card card-slot-projects liquid-float-d flex-1 h-full min-h-0 flex flex-col !pt-8 !pb-8 !px-5 sm:!px-6 animate-fade-in-up delay-1">
            <div data-edit="home.projectTitle" data-edit-label="作品板块标题" className="mb-6 shrink-0">
